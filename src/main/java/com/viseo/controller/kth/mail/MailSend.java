...
+ "	</p>"
+ "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"localhost/viseo/member/loginForm.blp\" target=\"_blank\"><p style=\"display: inline-block; width: 210px; height: 45px; margin: 30px 5px 40px; background: blue; line-height: 45px; vertical-align: middle; font-size: 16px;\">아이디 확인</p></a>"
+ "</div>";
	...
	public void sendMail(String mail) {
		...
		String content = "<div style=\"font-family: 'Apple SD Gothic Neo', 'sans-serif' !important; width: 540px; height: 600px; border-top: 4px solid blue; margin: 100px auto; padding: 30px 0; box-sizing: border-box;\">\r\n"
				...
				+ "	</p>\r\n"
				+ "\r\n"
				+ "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"localhost/viseo/member/checkMail.blp\" target=\"_blank\"><p style=\"display: inline-block; width: 210px; height: 45px; margin: 30px 5px 40px; background: blue; line-height: 45px; vertical-align: middle; font-size: 16px;\">메일 인증</p></a>\r\n"
				+ "\r\n"
				+ "	<div style=\"border-top: 1px solid #DDD; padding: 5px;\">\r\n"
				+ "		<p style=\"font-size: 13px; line-height: 21px; color: #555;\">\r\n"
				+ "			만약 버튼이 정상적으로 클릭되지 않는다면, 아래 링크를 복사하여 접속해 주세요.<br />\r\n"
				+ "			localhost/viseo/member/checkMail.blp\r\n"
				+ "		</p>\r\n"
				+ "	</div>\r\n"
				+ "</div>";
		Message message = new MimeMessage(session);
