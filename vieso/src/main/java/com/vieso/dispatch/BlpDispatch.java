 ...
 *			com.githrd.whistle.resources.properties
 *		
 *			작업이력)
 *					2022.05.11		- 클래스제작
 *										담당자 김태현
...
//			System.out.println("#### dispatch path : "+path);
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 	이 때 isRedirect의 속성값이 false인 경우는 forward
		 								true인 경우는 redirect
		 								null인 경우는 ajax로 처리
		 */
		// 1. 전체 요청 내용을 알아내고
...
//		System.out.println("#service full : "+full);	// /wihstle/main.blp
